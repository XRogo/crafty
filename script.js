...
function loadTile(tx, ty, level) {
    ...
    const PNG_IN_256 = new Set(['-2_2', '-2_1', '-3_1', '-4_1', '-8_1', '-9_1', '-2_0', '-3_0', '-4_0', '-8_0', '-9_0', '4_-1', '-2_-1', '-3_-1', '-4_-1', '-6_-1', '-7_-1', '-2_-3', '-3_-3', '-2_-4', '1_1', '-1_1', '1_0', '0_0', '-1_0', '1_-1', '-1_-1', '0_1', '0_-1','0_-6','-1_-5','-1_-6','0_-5','-5_2','-4_2','-3_-4','-3_2','-2_-2','-2_2','-1_-4','-1_2','0_2','1_2','-4_-2','-3_-2']);
    const tryLoad = (ext) => {
        const img = new Image();
